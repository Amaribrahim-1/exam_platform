...
function StatusSelect({ value, examId }) {
  ...
  return (
    <div ref={ref} className='relative w-32'>
      ...
      {/* القائمة */}
      {isOpen && (
        <div className='border-border bg-surface p- absolute top-8 left-0 z-50 w-full overflow-hidden rounded-lg border shadow-lg'>
